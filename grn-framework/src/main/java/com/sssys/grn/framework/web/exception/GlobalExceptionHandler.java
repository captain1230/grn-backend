package com.sssys.grn.framework.web.exception;
...
public class GlobalExceptionHandler {
    ...
    public CommonResult<?> handleServiceException(BusinessException e, HttpServletRequest request) {
        ...
        return Objects.nonNull(code) ?
                CommonResult.error(code, e.getMessage()) : CommonResult.serverError(e.getMessage());
    }
    ...
    public CommonResult<?> handleMissingPathVariableException(MissingPathVariableException e, HttpServletRequest request) {
        ...
        return CommonResult.serverError(String.format("请求路径中缺少必需的路径变量[%s]", e.getVariableName()));
    }
    ...
    public CommonResult<?> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException e, HttpServletRequest request) {
        ...
        return CommonResult.serverError(String.format("请求参数类型不匹配，参数[%s]要求类型为：'%s'，但输入值为：'%s'", e.getName(), e.getRequiredType().getName(), value));
    }
    ...
    public CommonResult<?> handleBindException(BindException e) {
        ...
        return CommonResult.serverError(message);
    }
